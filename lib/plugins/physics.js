...
const { EntityPhysics, BotcraftPhysics, EPhysicsCtx, PhysicsWorldSettings, initSetup } = require('@nxg-org/mineflayer-physics-util')
const { PlayerState } = require('@nxg-org/mineflayer-physics-util/dist/physics/states')
...
function inject (bot, { physicsEnabled, maxCatchupTicks }) {
  ...
  settings.overrides = { 
    // additional settings/attempts to modify the entity state can be used here. not sure how to make this elegant yet.
  }
